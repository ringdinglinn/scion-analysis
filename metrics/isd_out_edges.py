...
# Pattern to extract country code from Dir1 files
...
for f in os.listdir(cores_dir):
    ...
    # New nodes from special file not in basic file
    core_nodes_without_isd = total_core_nodes - all_nodes_in_isd
    
    # Count edges connecting core_nodes_without_isd to all_nodes_in_isd (using total_core_edges)
...
# Save to CSV
output_csv = "results/core_control_SG.csv"
